...
-E setup.kibana.host='elkmgr01:80' \
...
curl -XPUT -u elastic:changeme -H 'Content-Type: application/json' 'elkmgr01:9200/_ingest/pipeline/nyc_collision' -d @nyc_collision_pipeline.json && \
curl -XPUT -u elastic:changeme -H 'Content-Type: application/json' 'elkmgr01:9200/_template/nyc_collision' -d @nyc_collision_template.json && \
